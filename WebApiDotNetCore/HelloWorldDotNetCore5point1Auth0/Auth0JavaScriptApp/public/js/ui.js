...
const updateUI = async () => {
  try {
    ...
    if (isAuthenticated) {
      ...
      //show the call API button after authentication
      // document.getElementById("btn-call-api").disabled = !isAuthenticated;
      document.getElementById("btn-call-api-2").disabled = !isAuthenticated;
      document.getElementById("btn-call-api-3").disabled = !isAuthenticated;
      document.getElementById("btn-call-api-4").disabled = !isAuthenticated;
    }
    else {
