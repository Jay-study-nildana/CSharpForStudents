...
_"As a [type of user], I want [feature or functionality] so that [benefit or reason]."_
...
User Story 1:
_"As a shopper, I want to filter products by price so that I can find affordable items."_

User Story 2:
_"As an admin, I want to view analytics so that I can track user engagement."_
