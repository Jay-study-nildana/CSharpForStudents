# Revisiting C Sharp 2024 Edition - Basics
...
1. Structures
   1. [Example Project](OOPBasics2)
1. System.Object
   1. Overriding Methods of System.Object
      1. Equals()
      1. GetHashCode()
      1. GetType()
      1. ToString()
...
1. Delegates and Events
   ...
   1. Multi Cast Delegates
   1. Events
      1. Publisher Class
      1. Subscriber Class
      1. Auto Implemented Events
   1. Anonymous Methods
   1. Lambda Expressions
   1. Inline Lambda Expressions
   1. Func
   1. Action
   1. Predicate
   1. Event Handler
...
1. Arrays
   1. Creating Arrays
   1. Using for loop to loop through Arrays
...
1. Strings
   ...
   1. StringBuilder (also discuss Builder Pattern)
